            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        ...
                        <a href="${pageContext.request.contextPath}/services.html">Services</a>
                    </div>
                </div>
            </div>
        </div>
            	...
            	<c:forEach var="service" items="${listOfServices}">
	                ...
	                <div class="col-lg-3 col-md-6">
	                    <div class="feature_item">
	                        <img style="width: 200px; height: auto;" src="${pageContext.request.contextPath}/img/services/${service.filename}" alt="">
	                        <h4>${service.title}</h4>
