...
<link rel="icon"
	...
	type="image/png">
<title>Dharmendra Portfolio</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Dharmendra Kumar</h1>
					...
					<div class="col-lg-5">
						<div class="home_right_img">
							<img class=""
								src="${pageContext.request.contextPath}/img/banner/home-right.png"
								alt="">
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row justify-content-start align-items-center">
				<div class="col-lg-5">
					<div class="about_img">
						<img class=""
							src="${pageContext.request.contextPath}/img/about-us.png" alt="">
					</div>
				</div>
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<p>Whose given. Were gathered. There first subdue greater.
							Bearing you Whales heaven midst their. Beast creepeth. Fish days.
						</p>
						<p>Is give may shall likeness made yielding spirit a itself
							...
							you're gathering whose gathered cattle let. Creature whales fruit
							unto meat the life beginning all in under give two.</p>
